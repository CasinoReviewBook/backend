...
exports.createUserReview = exports.deleteCasinoReview = exports.updateCasinoReview = exports.createCasinoReview = exports.getCasinoReviewById = exports.getCasinoReviews = void 0;
const prisma_1 = require("../prisma");
const getCasinoReviews = async (req, res) => {
    try {
        const casinoId = String(req.params.casinoId);
        const reviews = await prisma_1.prisma.casinoReview.findMany({
...
exports.getCasinoReviews = getCasinoReviews;
const getCasinoReviewById = async (req, res) => {
    try {
        const id = String(req.params.id);
        const review = await prisma_1.prisma.casinoReview.findUnique({
            where: { id },
            include: { casino: true }
        });
        if (!review) {
...
exports.getCasinoReviewById = getCasinoReviewById;
const createCasinoReview = async (req, res) => {
    try {
        ...
        const review = await prisma_1.prisma.casinoReview.create({
            data: {
                casino_id,
                reviewer_name,
                reviewer_position,
...
exports.createCasinoReview = createCasinoReview;
const updateCasinoReview = async (req, res) => {
    try {
        const id = String(req.params.id);
        const { reviewer_name, reviewer_position, reviewer_experience_years, content, rating, verdict, status, sort_order } = req.body;
        const review = await prisma_1.prisma.casinoReview.update({
            where: { id },
            data: {
...
exports.updateCasinoReview = updateCasinoReview;
const deleteCasinoReview = async (req, res) => {
    try {
        const id = String(req.params.id);
        await prisma_1.prisma.casinoReview.delete({
            where: { id }
        });
...
exports.deleteCasinoReview = deleteCasinoReview;
...
//# sourceMappingURL=casinoReviewController.js.map